...
<form action="" method="POST">
	...
	<div class="form-group">
		...
		<input type="text" required name="name" class="form-control" value="<?php if(isset($name)){ echo $name; }else{ } ?>" placeholder="Nhập họ tên của bạn">
	</div>

	<div class="form-group">
		<label for="">Tài khoản (Email) <span style="color: red;">(*)</span></label>
		<input type="email" required name="user" class="form-control" value="<?php if(isset($user)){ echo $user; }else{ } ?>" placeholder="Nhập email của bạn">
	</div>
